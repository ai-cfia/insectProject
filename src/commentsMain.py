...
from src.apiUtils import getYesterday
from src.commentsEmailUtils import send_email
from src.commentsFlagUtils import flagList, preprocessComments
from src.commentsUtils import (
...
from src.preprocessUtils import FilterByLocaiton, SampleImg
...
##########################################################
################################# get new comments
queryIsComplete, allComments, commentStatus = getComments(
    maxCountTrials, dates, queryPairs, commentStatus, iconic_taxa
)
...
if queryIsComplete:
    ...
    Title = (
        "Flagged Comments Submitted in the "
        + str(interval)
        + " Days Preceding to "
        + datefrom
    )
