...
from src.model1 import getModel1


def getModels():
    models = []
    nonInvasive1 = {"name": "Monochamus scutellatus", "id": "82043"}
    ...
    m1 = {
        ...
        ],  # use common name because the way they are flagging these species specifically are by using the upper taxa so the scientific name would be that of the upper taxa and not of the invasive subspecies inside of it (i.e., not the ones we are targetting)
